<div id="registration">      
<div id="registration-title">Регистрация</div>
	[registration]Регистрация нового пользователя[/registration]<br> 
	[validation]Обновление профиля пользователя[/validation]<br>
 	[registration]
...
<div id="registration-footer"> <button name="submit" class="buttonn" type="submit"><span>Отправить</span></button>  </div>
</div>