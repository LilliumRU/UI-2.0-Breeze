...
<div id="addnews">
<div id="addnews-title">Добавить новость</div> 
<div id="addnews-cont">   
<table>
<tr>
...
<div class="bb-editor">
{bbcode}
<textarea name="full_story" id="full_story" onfocus="setFieldName(this.name)" rows="20" class="f_textarea" >
{full-story}
</textarea>
</div>
[/not-wysywyg]
...
<button class="buttonn" name="add" type="submit"><span>Отправить</span></button>
<button class="buttonn" name="nview" onclick="preview()" type="submit"><span>Просмотр</span></button>
</div> 
</div>     
</div>    