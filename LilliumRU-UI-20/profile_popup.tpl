...
<div class="userinfo">
		...
		<div class="rcol">
			<ul class="reset">
				...
				<li><span class="grey">Дата посещения:</span> <b>{lastdate}</b>, <span class="grey">cтатус:</span> 
				...
				<li><span class="grey">Публикаций:</span> {news-num} [ {news} ] [rss]<img src="http://files.lillium.ru/dle/rss.png" alt="rss" style="vertical-align: middle; margin-left: 5px;" />[/rss]</li>
