...
<div id="pm">
[pmlist]<div id="pm-title">Список сообщений</div>[/pmlist]
...
<div class="baseform">
	<table class="tableform">
		...
		<tr>
			...
			<td class="editorcomm">
			{editor}<br />
			<div class="checkbox"><input type="checkbox" id="outboxcopy" name="outboxcopy" value="1" /> 
                <label for="outboxcopy">Сохранить сообщение в папке "Отправленные"</label></div>
			</td>
		</tr>
		[sec_code]
		<tr>
...
<div class="bcomment">
	...
	<div class="cominfo"><div class="dpad">
		...
		<ul class="cominfo reset">
			...
			<li>Статус: 
                ...
                [offline]<img src="http://files.lillium.ru/dle/offline.png" style="vertical-align: middle;" title="Пользователь offline" alt="Пользователь offline" />[/offline]</li>
	...
	<div class="dcont">
        ...
        <div class="signature">--------------------</div><div class="slink">{signature}</div>[/signature]
		<div class="clr"></div>
	</div>
</div>
[/readpm]
